...
class FirstHello(Cmd):

    """
    This command class just implements 'First Hello' for demonstration.
    ...
    def exec(self, cmdinput:dict):
        ...
        try:
            ...
            # -------------------------------------------------------------
            value = self.__get_response(app, self.name, param)
    ...
    def __get_response(self, app:str, cmd:str, param:str):
